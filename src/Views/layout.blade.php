...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('installerfiles/assets/css/bootstrap.min.css') }}">
    <link rel="stylesheet" href="{{ asset('installerfiles/assets/style.css') }}">
</head>
<body>
            ...
            <div class="row">
                <div class="col-xl-4 col-lg-6 col-md-8">
                    <div class="breadcrumb-text">
                        <a class="brand-logo" href="javascript:void(0)"><img src="{{ asset('installerfiles/assets/images/logo.png') }}" alt="logo" /></a>
                        <h2>{{__('Web Installer - A Laravel Web Installer for all script')}}</h2>
    ...
    <script src="{{ asset('installerfiles/assets/js/bootstrap.bundle.min.js') }}"></script>
</body>
</html>
